      ...
      vi.fn().mockResolvedValue({
        ...
        json: async () => ({
          settings: {
            ...
            prompts: { system: '', summarizePromptTemplate: '', highlightsPromptTemplate: '' },
            tasks: {
              chat: { maxOutputTokens: 120, maxContextItems: 5, temperature: 0.2 },
              summarize: { maxOutputTokens: 120, maxContextItems: 5, temperature: 0.2 },
            },
