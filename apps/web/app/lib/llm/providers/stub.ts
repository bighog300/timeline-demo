...
const buildSynthesisStubReply = (contextSourceCount: number) =>
  [
    ...
    '',
    '## Actor timelines',
    '- Actor: Project Lead | Date/Time: 2024-01-02 | Action: Drafted launch plan. | Outcome/Impact: Set initial direction [1].',
    '- Actor: Team members | Date/Time: date not specified | Action: Shared follow-up updates. | Outcome/Impact: Kept execution moving [1].',
    '',
    '## Themes grouped view',
    '- Theme: contract/payment | Event: Launch planning clarified scope and ownership [1].',
    '- Theme: conflict/escalation | Event: Follow-up messages show pressure around deadlines [1].',
    '',
